...
def get_vector_store(text_chunks):
    ...
    model_identifier = "text-embedding-v1"  # Example model name, update with actual identifier
...
def user_input(user_question):
    # Replace with the correct model identifier
    model_identifier = "gemini-1.5-pro"  # Example model name, update with actual identifier
    embeddings = GoogleGenerativeAIEmbeddings(model=model_identifier, google_api_key=api_key)
